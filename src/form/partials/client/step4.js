...
class Step4 extends Component {
  render() {
    ...
    return (
      <React.Fragment>
        <AntInput name="clientHomeAddress" help="Street Address" label="Client home address" formProps={props.formProps} />
        <Row gutter={30}>
          <Col lg={12} md={12} sm={24} xs={24}>
            <AntInput name="clientCity" help="City" formProps={props.formProps} />
          </Col>
          <Col lg={12} md={12} sm={24} xs={24}>
            <AntInput name="clientState" help="State" formProps={props.formProps} />
          </Col>
        </Row>
        <Row gutter={30}>
          <Col lg={12} md={12} sm={24} xs={24}>
            <AntInput name="clientPostCode" help="Post Code" formProps={props.formProps} />
          </Col>
          <Col lg={12} md={12} sm={24} xs={24}>
            <AntInput
              help="Country"
